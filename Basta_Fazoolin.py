class Business:
     ...
     def __repr__(self):
          return "At " + self.name + " we belive in customer service! " + str(self.franchises)
...
class Franchise:
  ...
  def __repr__(self):
          return "Our restaurant is located at " + self.address
...
early_bird_menu = Menu("Early Brid", early_bird_items, 1500, 1800)
...
#print(dinner_menu.calculate_bill(["caesar salad", "pizza with quatto formaggi"]))
...
arepa_businnes = Business("Take a' Arepa", arepas_place)
